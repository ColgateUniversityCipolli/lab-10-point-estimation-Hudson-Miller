...
\pandocbounded{\includegraphics[keepaspectratio]{Lab10WriteUp_files/figure-pdf/unnamed-chunk-5-1.pdf}}
...
\AttributeTok{breaks =} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{6}\NormalTok{, }\DecValTok{1}\NormalTok{)) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{Lab10WriteUp_files/figure-pdf/unnamed-chunk-6-1.pdf}}
